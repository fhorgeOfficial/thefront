...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="https://cdn01.alison-static.net/public/html/site/img/sharing/alison-occupations-share.png">
        <meta property="og:url" content="https://alison.com/careers"/>
        <meta property="og:description" content="Search for your ideal career by Industry, Career Path or Occupation on the Alison Career Guide. Complete the courses to gain the skills you need to succeed."/>
        <meta name="twitter:card" content="summary">
        <meta name="twitter:site" content="@AlisonCourses">
        <meta name="twitter:creator" content="@AlisonCourses">
        <meta name="twitter:url" content="https://alison.com/careers">
        <meta name="twitter:title" content="Find your perfect career | Alison Careers">
        <meta name="twitter:description" content="Search for your ideal career by Industry, Career Path or Occupation on the Alison Career Guide. Complete the courses to gain the skills you need to succeed.">
        <meta name="twitter:image" content="https://cdn01.alison-static.net/public/html/site/img/sharing/alison-occupations-share.png">
        <meta name="csrf-token" content="h0BNAKWg0xF5RQX8ADHv9mtgSH4xK6ARCE18W5Gv">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="canonical" href="https://alison.com/careers"/>
        <link rel="alternate" href="https://alison.com/careers" hreflang="x-default"/>
        <link rel="alternate" href="https://alison.com/careers" hreflang="en"/>
        <link rel="alternate" href="https://alison.com/es/carreras" hreflang="es"/>
        <link rel="alternate" href="https://alison.com/fr/carrières" hreflang="fr"/>
        <link rel="alternate" href="https://alison.com/it/carriere" hreflang="it"/>
        <link rel="alternate" href="https://alison.com/pt-BR/carreiras" hreflang="pt-br"/>
        ...
        <link rel="stylesheet" href="../html/site/css/occupations--categories.css">
    </head>
                ...
                <span class="nav__item nav__item--dd nav__item--slide nav__item--languages activate-dropdown ">
                    ...
                    <div class="nav__dd nav__dd--slide nav__dd--languages" style="display: none">
                        <ul>
                            ...
                            <li class="selected">
                                <a rel="alternate" hreflang="en" href="https://alison.com/careers">
                                    <span>
                            ...
                            <li>
                                <a rel="alternate" hreflang="es" href="https://alison.com/es/carreras">
                                    <span>
                            ...
                            <li>
                                <a rel="alternate" hreflang="fr" href="https://alison.com/fr/carrières">
                                    <span>
                            ...
                            <li>
                                <a rel="alternate" hreflang="it" href="https://alison.com/it/carriere">
                                    <span>
                            ...
                            <li>
                                <a rel="alternate" hreflang="pt-BR" href="https://alison.com/pt-BR/carreiras">
                                    <span>
...
<div id="new_careers" class="careers-categories">
    <div class="banner-container ">
        <div class="banner">
            <figure class="bg-image">
                <img src="../html/site/img/careers/careers-categories-page-header-img.png">
            </figure>
    ...
    <div class="careers__inner careers__inner--padding ">
            ...
            <div class="container search-bar-outer">
                <div class="row search-bar">
                    <div class="col-md-4 col-md-4--modified text-right text-sm-center">
                        <p class="top-action-paragraph">
                            Get started by <strong>selecting your preferred career category, or</strong>
                        </p>
                    </div>
                    ...
                    <div class="col-md-2 text-right back-to-careers-desktop">
                        <a href="https://alison.com/careers/full-list">
                            <span class="icon-view-all-careers-link"></span>
                            View All Careers As a List
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="career-ad career-ad--mobile" style="width:320px;max-height:100px;height:100px;">
            <ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-4877892089121284" data-ad-slot="7540556127" data-auto-ad-size="false" data-full-width-responsive="false"></ins>
            <script>
                (adsbygoogle = window.adsbygoogle || []).push({});
            </script>
        </div>
        <section class="regular-wrapper">
            <div class="categories-holder text-center"></div>
            <br/>
            <br/>
        </section>
        <div class="back-to-careers-mobile text-center">
            <div style="margin-top: -20px; margin-bottom: 20px;">
                <a href="https://alison.com/careers/all-careers">
                    <span class="icon-view-all-careers-link"></span>
                    View All Careers As a List
                </a>
            </div>
    ...
    <div class="sticky-ad inner-page-sticky-ad occupations-advert">
        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-4877892089121284" data-ad-slot="1994082954" data-ad-format="auto"></ins>
    </div>
</div>
...
<script type='text/javascript' src="../html/site/js/handlebars-templates/rendered-templates/careers-partials.js"></script>
<script>
    $(document).ready(function() {
        var careerCategories = new CareerCategories();
        careerCategories.initialize();
        $("body").on('mouseenter', '.occupations-card-wrapper', function() {
            if (window.innerWidth > 480) {
                $(this).find('.occupations-card-top').addClass('hidden');
                $(this).find('.occ-card-base').removeClass('hidden');
            }
        }).on('mouseleave', '.occupations-card-wrapper', function() {
            if (window.innerWidth > 480) {
                $(this).find('.occ-card-base').addClass('hidden');
                $(this).find('.occupations-card-top').removeClass('hidden');
            }
        });
    ...
    function CareerCategories() {
        var that = this;
        this.careersCategoriesListingTemplate = function(data) {
            var sortedData = this.sortByProperty(data, 'slug');
            var careersUrl = "https://alison.com/careers/it".substring(0, ("https://alison.com/careers/it".lastIndexOf("/")));
            $.each(sortedData, function(index, item) {
                if ('en' !== 'en') {
                    item.description = that.trimStringToLength(that.cleanText(item.description), 185, true);
                    item.img_root = item.image_url.split('.jpg')[0];
                } else {
                    item.description = (/<[a-z/][\s\S]*>/i.test(item.description)) ? that.trimStringToLength($(item.description).text(), 185, true) : that.trimStringToLength(item.description, 185, true);
                }
                item.new_image_name = (item.image_name) ? item.image_name.replace('.png', '--new.jpg') : '';
                item.new_image_url = (item.image_url) ? item.image_url.replace('.png', '--new.jpg') : '';
            });
            var careersCategoriesListingTemplate = $.parseHTML(Handlebars.partials['careers--categories__listing']({
                data: sortedData,
                careers_url: careersUrl,
            }));
            $('.categories-holder').append(careersCategoriesListingTemplate);
            if ($(window).width() > 1199) {
                (adsbygoogle = window.adsbygoogle || []).push({});
            }
            setTimeout(function() {
                innerPageStickyAd('.inner-page-sticky-ad', 350 + ($('#announcement').length > 0 || $('#sale').length > 0 ? 60 : 0));
            }, 300);
        }
        ;
        this.initialize = function() {
            this.getAllCareerCategories();
        }
        ;
        this.getAllCareerCategories = function() {
            $('.loading').fadeIn();
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 200) {
                        $('.loading').fadeOut();
                        that.careersCategoriesListingTemplate(response.result);
                    }
                },
                error: function(error) {
                    $('.loading').fadeOut();
        ...
        ;
        this.cleanText = function(string) {
...
<script>
    var route_name = "site.occupations-v2";
            ...
            loadScript('https://apis.google.com/js/api:client.js', function() {
                ...
                function redirectUser(element) {
                    auth2.attachClickHandler(element, {}, function(googleUser) {
                        ...
                        window.location = window.location.protocol + '//' + window.location.hostname + '/auth/google-token-sign-in/' + response.id_token + '?redirect_url=https://alison.com/careers&route_name=site.occupations-v2';
                    }, function(error) {
                ...
                if ($('#login').length === 0) {
                    let lang = {
                      ...
                      , route = {
                        ...
                        'current_url': 'https://alison.com/careers',
                        'route_name': 'site.occupations-v2',
                        'previous_url': 'https://alison.com/mobile/online-learning-app',
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7d56d9f8aa37719f","token":"263a0b32707e43db9835c488586fa192","version":"2023.4.0","si":100}' crossorigin="anonymous"></script>
</body></html>
