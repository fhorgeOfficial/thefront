var OneTrustStub = function(e) {
    ...
    (A = v = v || {}).AfterTitle = "AfterTitle",
    A.AfterDescription = "AfterDescription",
    A.AfterDPD = "AfterDPD",
    (C = b = b || {}).PlusMinus = "Plusminus",
    C.Caret = "Caret",
    C.NoAccordion = "NoAccordion",
    (y = I = I || {}).Consent = "Consent",
    y.LI = "LI",
    y.AddtlConsent = "AddtlConsent",
    (L = S = S || {}).Iab1Pub = "eupubconsent",
    L.Iab2Pub = "eupubconsent-v2",
    L.Iab1Eu = "euconsent",
    L.Iab2Eu = "euconsent-v2",
    (w = T = T || {})[w.Disabled = 0] = "Disabled",
    w[w.Consent = 1] = "Consent",
    w[w.LegInt = 2] = "LegInt",
    (R = D = D || {})[R["Banner - Allow All"] = 1] = "Banner - Allow All",
    ...
    (M = k = k || {})[M.RTL = 0] = "RTL",
    M[M.LTR = 1] = "LTR",
    (V = F = F || {})[V.GoogleVendor = 1] = "GoogleVendor",
    V[V.GeneralVendor = 2] = "GeneralVendor",
    (H = x = x || {})[H.Days = 1] = "Days",
    H[H.Weeks = 7] = "Weeks",
    H[H.Months = 30] = "Months",
    H[H.Years = 365] = "Years",
    (q = j = j || {}).Checkbox = "Checkbox",
    q.Toggle = "Toggle",
    ...
    (ne = te = te || {}).granted = "granted",
    ne.denied = "denied",
    (ae = ie = ie || {})[ae.HostList = 0] = "HostList",
    ...
    Re[Re.CmpVersion = 1] = "CmpVersion";
    var _e, Be, Oe, Ge, Ue = "geo", Ne = "otpreview", ke = (ue.Name,
    "PRODUCTION"), Me = ((Pe = {})[x.Days] = "PCenterVendorListLifespanDay",
    Pe[x.Weeks] = "LfSpnWk",
    ...
    var xe = new function() {
        ...
        this.init = function() {
            r.win.__gpp && "function" == typeof r.win.__gpp || (r.win.__gpp = r.executeGppApi,
        ...
        this.executeGppApi = function() {
            for (var e, t = [], n = 0; n < arguments.length; n++)
                t[n] = arguments[n];
            if (!t.length)
                return (null === (e = r.win) || void 0 === e ? void 0 : e.__gpp).queue || [];
            var i = t[0]
        ...
        this.addFrame = function(e) {
            ...
            if (!n)
                if (t.body) {
                    ...
                    i.name = e,
                    i.setAttribute("title", "GPP Locator"),
        ...
        this.messageHandler = function(i) {
            ...
            if (t && t.__gppCall) {
                var o = t.__gppCall;
                (0,
                r.win.__gpp)(o.command, function(e, t) {
                    var n = {
                        __gppReturn: {
                            returnValue: e,
                            success: t,
    ...
    je.prototype.fetchBannerSDKDependency = function() {
        ...
        this.crossOrigin = Ee.stubScriptElement.getAttribute("crossorigin") || null,
        this.previewMode = "true" === Ee.stubScriptElement.getAttribute("data-preview-mode"),
    ...
    je.prototype.setDomainIfBulkDomainEnabled = function(e) {
        ...
        if (t && t.CookieV2BulkDomainManagement && n !== i && e.ScriptType === ke) {
            ...
            if (o && o.getItem("bulkDomainMgmtEnabled"))
    ...
    je.prototype.getLocation = function(e) {
        if (this.setDomainIfBulkDomainEnabled(e),
        (e.TenantFeatures && e.TenantFeatures.CookieV2CSP || e.CookieV2CSPEnabled) && this.nonce && (this.setAttributePolyfillIsActive = !0,
        (new Me).implementThePolyfill()),
        !e.RuleSet[0].Type)
    ...
    je.prototype.handleBulkDomainMgmt = function(e, t) {
        window.sessionStorage && window.sessionStorage.setItem("bulkDomainMgmtEnabled", JSON.stringify(e.isValid)),
    ...
    je.prototype.otFetch = function(e, n, t, i, a) {
        ...
        if (new RegExp("^file://","i").test(e))
            this.otFetchOfflineFile(e, n);
            ...
            if (s.onload = function(e) {
                var t;
                this && this.responseText ? t = this.responseText : e && e.target && (t = e.target.responseText),
                a ? n(JSON.parse(t), a) : n(JSON.parse(t))
            }
            ,
            s.onerror = function() {
                n()
    ...
    je.prototype.jsonp = function(e, t) {
        ...
        this.crossOrigin && n.setAttribute("crossorigin", this.crossOrigin),
        document.getElementsByTagName("head")[0].appendChild(n),
        new RegExp("^file://","i").test(e) || Ee.mobileOnlineURL.push(e),
        t && (n.onload = n.onerror = function() {
            t()
        }
        )
    }
    ...
    je.prototype.getRegionSet = function(e) {
        var t, n, i, a = Ee.userLocation, o = e.RuleSet.filter(function(e) {
            return !0 === e.Default
        });
    ...
    je.prototype.validateIABGlobalScope = function() {
        ...
        e ? "true" === e ? (Ee.hasIABGlobalScope = !0,
        Ee.isStubReady = !1) : (Ee.hasIABGlobalScope = !1,
        Ee.IABCookieValue = this.getCookie(Ee.oneTrustIABCookieName)) : Ee.isStubReady = !1
    }
    ,
    ...
    je.prototype.readCookieParam = function(e, t) {
        ...
        if (r) {
            ...
            n = 0; n < a.length; n += 1)
                o = a[n].split("="),
                i[decodeURIComponent(o[0])] = decodeURIComponent(o[1]).replace(/\+/g, " ");
    ...
    je.prototype.getCookie = function(e) {
        ...
        for (n = 0; n < o.length; n += 1) {
            for (i = o[n]; " " == i.charAt(0); )
                i = i.substring(1, i.length);
            if (0 == i.indexOf(a))
                return i.substring(a.length, i.length)
        }
        return null
    }
    ,
    je.prototype.updateGtmMacros = function() {
        var e, t = [], n = Ee.optanonHtmlGroupData.length;
        for (e = 0; e < n; e++)
            this.endsWith(Ee.optanonHtmlGroupData[e], ":1") && t.push(Ee.optanonHtmlGroupData[e].replace(":1", ""));
        for (n = Ee.optanonHostData.length,
        e = 0; e < n; e++)
            this.endsWith(Ee.optanonHostData[e], ":1") && t.push(Ee.optanonHostData[e].replace(":1", ""));
        for (n = Ee.genVendorsData.length,
        e = 0; e < n; e++)
            this.endsWith(Ee.genVendorsData[e], ":1") && t.push(Ee.genVendorsData[e].replace(":1", ""));
        for (n = Ee.vendorsServiceData.length,
        e = 0; e < n; e++)
            this.endsWith(Ee.vendorsServiceData[e], ":1") && t.push(Ee.vendorsServiceData[e].replace(":1", ""));
        var i = "," + this.serialiseArrayToString(t) + ",";
        window.OnetrustActiveGroups = i,
        window.OptanonActiveGroups = i;
        var a = window;
        ...
        setTimeout(function() {
            t.length && window.dispatchEvent(r),
    ...
    je.prototype.setStubScriptElement = function() {
        ...
        Ee.stubScriptElement && Ee.stubScriptElement.hasAttribute(Ee.DATAFILEATTRIBUTE) ? this.domainId = Ee.stubScriptElement.getAttribute(Ee.DATAFILEATTRIBUTE).trim() : e ? this.domainId = Ee.stubScriptElement.getAttribute("src").split("did=")[1] : Ee.stubScriptElement || (Ee.stubScriptElement = document.querySelector("script[src*='" + Ee.migratedCCTID + "']"),
        Ee.stubScriptElement && (Ee.isMigratedURL = !0,
    ...
    je.prototype.setDomainDataFileURL = function() {
        ...
        e && (Ee.isMigratedURL ? Ee.storageBaseURL = e.split("/consent/" + Ee.migratedCCTID)[0] : Ee.storageBaseURL = t ? e.split("/consent")[0] : e.split("/scripttemplates/" + Ee.stubFileName)[0]),
        ...
        Ee.bannerBaseDataURL = Ee.storageBaseURL && Ee.storageBaseURL + "/consent/" + this.domainId,
        Ee.bannerDataParentURL = Ee.bannerBaseDataURL + "/" + this.domainId + ".json"
    }
    ,
    ...
    je.prototype.getParam = function() {
        ...
        this.isReset = e || n && new Date(n) < new Date,
        this.isPreview = !this.isReset && (t || n && new Date(n) > new Date),
    ...
    function je() {
        ...
        this.addBannerSDKScript = function(e) {
            ...
            t.GCEnable || (p.updateGtmMacros(),
            p.gtmUpdated = !0),
            p.iabTypeAdded && ("IAB" !== t.Type && "IAB2" !== t.Type || (p.iabType = t.Type,
            p.intializeIabStub()),
            "IAB2" !== t.Type && p.removeTcf()),
            t.IsGPPEnabled ? xe.init() : xe.removeGppApi();
            var n = Ee.stubScriptElement.cloneNode(!0)
              , i = "";
            i = e.UseSDKRefactor ? (Ee.isMigratedURL && (n.src = Ee.storageBaseURL + "/scripttemplates/new/scripttemplates/" + Ee.stubFileName + ".js"),
            Ee.storageBaseURL + "/scripttemplates/new/scripttemplates/" + e.Version + "/" + Ee.bannerScriptName) : "5.11.0" === e.Version ? (Ee.isMigratedURL && (n.src = Ee.storageBaseURL + "/scripttemplates/old/scripttemplates/" + Ee.stubFileName + ".js"),
            Ee.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + Ee.bannerScriptName) : (Ee.isMigratedURL && (n.src = Ee.storageBaseURL + "/scripttemplates/" + Ee.stubFileName + ".js"),
            Ee.storageBaseURL + "/scripttemplates/" + e.Version + "/" + Ee.bannerScriptName);
            ...
            p.charset = Ee.stubScriptElement.getAttribute("charset"),
            p.isAmp = !!Ee.stubScriptElement.getAttribute("amp"),
            window.otStubData = {
        ...
        this.intializeIabStub = function() {
            var e = window;
            p.iabTypeAdded ? ("IAB" === p.iabType ? void 0 === e.__cmp && (window.__cmp = p.executeCmpApi) : void 0 === e.__tcfapi && (window.__tcfapi = p.executeTcfApi),
            p.addIabFrame()) : p.addBackwardIabFrame(),
            e.receiveOTMessage = p.receiveIabMessage,
        ...
        this.receiveIabMessage = function(i) {
            ...
            if (e.__cmpCall && "IAB" === p.iabType) {
                ...
                e.__cmpCall && "IAB2" === p.iabType && console.log("Expecting IAB TCF v2.0 vendor iFrame call; Received IAB TCF v1.1");
            if (e.__tcfapiCall && "IAB2" === p.iabType) {
                var s = e.__tcfapiCall.callId
                  , l = e.__tcfapiCall.command
                  , n = (t = e.__tcfapiCall.parameter,
                ...
                e.__tcfapiCall && "IAB" === p.iabType && console.log("Expecting IAB TCF v1.1 vendor iFrame call; Received IAB TCF v2.0")
        }
        ,
